    ...
    <footer className="flex justify-center items-center w-full dark:bg-stone-950 bg-stone-800 px-5 text-stone-100">
      <div className="py-2.5 flex flex-wrap justify-between max-w-5xl w-full items-center text-sm gap-x-5 gap-y-3">
        ...
        <div className="flex gap-4 items-center justify-center">
          ...
          {/* Instagram */}
          <a href="https://www.instagram.com/inefan.gr/" target="_blank" rel="noopener noreferrer" className="transition-opacity duration-200 flex items-center justify-center opacity-50 hover:opacity-100 will-change-transform">
          ...
          {/* Youtube */}
          <a href="https://www.youtube.com/channel/UC5GXzo05fMKi4aeN4D7rLRw" target="_blank" rel="noopener noreferrer" className="transition-opacity duration-200 flex items-center justify-center opacity-50 hover:opacity-100 will-change-transform">
