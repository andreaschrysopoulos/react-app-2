  ...
  return (
    <div className="flex flex-col gap-3 justify-center h-full max-w-sm w-full">
      ...
      >
        ...
        />
        <button
          className="cursor-pointer w-25 py-2 px-3 rounded-tr-[4.8px] rounded-br-[4.8px] dark:bg-indigo-700 dark:hover:bg-indigo-600 bg-indigo-50 hover:bg-indigo-100 font-medium transition-all duration-200"
          type="submit"
        >
          Subscribe
        </button>
