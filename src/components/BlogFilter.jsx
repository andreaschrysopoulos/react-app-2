  ...
  return (
    <div className='flex gap-2 overflow-x-auto items-center justify-between'>
      <div className="flex items-center dark:bg-stone-900 bg-stone-200 py-1 px-1 rounded-full">
        ...
        <div className={`${isToggled('economics')} mr-1 border-stone-200 dark:border-stone-800 px-3 py-1 rounded-full cursor-pointer transition-all duration-200`} onClick={() => toggleCategory("economics")}>Economics</div>
        <div className={`${isToggled('international')} mr-1 border-stone-200 dark:border-stone-800 px-3 py-1 rounded-full cursor-pointer transition-all duration-200`} onClick={() => toggleCategory("international")}>International</div>
        <div className={`${isToggled('financial')} mr-1 border-stone-200 dark:border-stone-800 px-3 py-1 rounded-full cursor-pointer transition-all duration-200`} onClick={() => toggleCategory("financial")}>Financial</div>
