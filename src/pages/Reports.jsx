  ...
  return (
    <div className="flex flex-auto px-5 pb-10">
      ...
      <div className="flex flex-col size-full max-w-5xl mx-auto">
        ...
        {/* Page Header */}
        <span className='font-semibold text-6xl dark:text-white'>Reports</span>

        {/* Two Section Board */}
        <div className="mt-10 flex size-full">

          {/* Reports */}
          <div className="flex flex-col min-w-fit text-sm p-2 mr-3 dark:bg-stone-900 bg-stone-200 rounded-3xl dark:text-stone-200 text-stone-800">
            {reports.map(report =>
          ...
          <div className="flex flex-col w-full px-7 py-5 dark:bg-stone-900 bg-stone-200 rounded-3xl">
            {
              reports.map(report =>
                <ReportContent key={report.key} highlight={highlight} track={report.key} description={report.description} title={report.title} subtitle={report.subtitle} />
              )
            }
          </div>
