    ...
    <>
      <div className="flex flex-auto pb-20 px-5">
        <div className="flex flex-col mx-auto max-w-5xl w-min">
          ...
          <span className='font team3:text-3xl text-2xl mb-10 dark:text-stone-400 text-stone-500'>The Board of Directors at Inefan leads with diverse expertise in economics, finance, and entrepreneurship, guiding our mission to connect youth with education and career opportunities.</span>
